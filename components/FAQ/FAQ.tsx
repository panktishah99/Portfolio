            ...
            <div className="w-full">
              ...
              >
                <div className="flex items-center gap-2 justify-between">
                  ...
                  <motion.div
                    className="bg-dark-gray-2 flex-shrink-0 border border-dark-gray-4 rounded-[10px] flex items-center justify-center p-2 faq-plus-icon"
                  ...
                  >
                    <Image
                      ...
                      style={{
                        opacity: openIndices.includes(index) ? 1 : 0.85,
                      }}
                      width={20}
                      height={20}
                    />
                  ...
                  {openIndices.includes(index) && (
                    ...
                    >
                      ...
                      <motion.p
                        ...
                        exit={{ opacity: 0, y: 10 }}
                        transition={{ duration: 0.3 }}
                        className="faq-answer-text font-medium text-[16px]"
                      >
                        {faq.answer}
                      </motion.p>
                    </motion.div>
